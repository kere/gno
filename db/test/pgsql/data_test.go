...
func Test_row2struct(t *testing.T) {
	s := `{"content":"this is a message.","empty_str":null,"begin_at":"2014-11-25T16:00:00.000Z","end_at":"2014-11-27T16:00:00.000Z","users1":[[0,6],[1,5],[2,4]],"users2":[1,3,4],"users3":[1,2],"strarr1":"{'a','b'}","strarr2":"{{'a','b'},{'a2','b2'}}","strarr3":"{'a3','b3'}"}`
	row := db.DataRow{}
	json.Unmarshal([]byte(s), &row)
